...
## Project Structure
    ...
    ├── testapiautostoryboa_68707  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_68707`
...
2. Clone this repo and `cd testapiautostoryboa_68707`
